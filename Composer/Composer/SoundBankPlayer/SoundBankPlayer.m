...
@interface SoundBankPlayer () <AVAudioSessionDelegate>
...
- (BOOL)setUpAudioSession
{
    ...
    success = [session setCategory:AVAudioSessionCategoryAmbient withOptions:AVAudioSessionCategoryOptionMixWithOthers error:&error];
    if (!success) {
...
- (void)audioSessionBeginInterruption
{
    BOOL success = [self tearDownAudioSession];
...
- (void)audioSessionEndInterruption
{
    ...
    BOOL success = [self setUpAudioSession];
